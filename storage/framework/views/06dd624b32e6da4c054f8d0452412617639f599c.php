        ...
        <div class="single-page-block-inner effect-3d-element">
            ...
            <div class="single-page-block-form">
                <h3 class="text-center">
                    ...
                    <?php echo app('translator')->getFromJson('frontend/global.app_resetpasswordform'); ?>
                </h3>
                <br />
				...
				<?php endif; ?>
                <form id="form" name="form" method="POST" action="<?php echo e(url('password/email')); ?>">
                    <div class="form-group">
                        <input id="email" class="form-control" placeholder="Email" name="email" type="text" value="<?php echo e(old('email')); ?>">
                    </div>

                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary width-150"><?php echo app('translator')->getFromJson('frontend/global.app_resetpassword'); ?></button>
                    </div>
