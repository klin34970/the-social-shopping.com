        ...
        <div class="single-page-block-inner effect-3d-element">
            ...
            <div class="single-page-block-form">
                <h3 class="text-center">
                    ...
                    @lang('frontend/global.app_registrationform')
                </h3>
                <br />
				@if (count($errors) > 0)
				...
				@endif
                <form id="form" name="form" method="POST" action="{{ route('home.registration') }}">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary width-150">@lang('frontend/global.app_signup')</button>
                    </div>
