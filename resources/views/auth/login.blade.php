        ...
        <div class="single-page-block-inner effect-3d-element">
            ...
            <div class="single-page-block-form">
                <h3 class="text-center">
                    ...
                    @lang('frontend/global.app_loginform')
                </h3>
                <br />
				@if (count($errors) > 0)
				...
				@endif
                <form id="form" name="form" method="POST" action="{{ url('login') }}">
                    ...
                    <div class="form-group">
                        <a href="{{ route('auth.password.reset') }}" class="pull-right">@lang('frontend/global.app_forgotpassword')?</a>
						<br>
						<a href="{{ route('home.registration') }}" class="pull-right">@lang('frontend/global.app_signup')</a>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="remember" checked>
                                @lang('frontend/global.app_rememberme')
                            </label>
                        </div>
                    </div>
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary width-150">@lang('frontend/global.app_signin')</button>
                    </div>
