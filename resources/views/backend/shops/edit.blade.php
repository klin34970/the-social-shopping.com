...
@section('content')  
	{!! Form::model($shop, ['files'=> true, 'method' => 'PUT', 'route' => ['backend.shop.update', $shop->id]]) !!}
					...
					<div class="row">
						...
						<div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="form-group">
								...
								@if($shop->logo)
									{{ Form::file('logo', ['data-default-file' => '/storage' . $shop->logo . $shop->id . '/' . File::basename(File::glob(storage_path('app/public') . $shop->logo . $shop->id . '/200x200.*')[0]), 'class' => 'dropify', 'required' => false]) }}
								@else
					...
					<div class="row">
						...
						<div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="form-group">
								...
								{!! Form::text('key_public', $shop->stripe->key_public ? $shop->stripe->key_public : null, ['class' => 'form-control', 'id' => 'key_public', 'required' => true]) !!}
							</div>
						</div>
						<div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="form-group">
								<label class="form-control-label" for="key_private">@lang('backend/global.shop.fields.key_private')</label>
								{!! Form::text('key_private', $shop->stripe->key_private ? $shop->stripe->key_private : null, ['class' => 'form-control', 'id' => 'key_private', 'required' => true]) !!}
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="form-group">
								...
								{!! Form::text('facebook_pixel_code', $shop->facebook_pixel ? $shop->facebook_pixel->facebook_pixel_code : null, ['class' => 'form-control', 'id' => 'facebook_pixel_code', 'required' => false]) !!}
							</div>
						</div>
