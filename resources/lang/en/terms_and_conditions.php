...
return [
	...
	'text' =>
	"
		<h2>Welcome to The Social Shopping</h2>
		<p>These terms and conditions outline the rules and regulations for the use of The Social Shopping's Website.</p>
		<p><br /> <span style='text-transform: capitalize;'> The Social Shopping</span> is located at:</p>
		<address>14 plan de la brigantine , Lattes<br />Languedoc Roussillon - 34970, France</address>
		<p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use The Social Shopping's website if you do not accept all of the terms and conditions stated on this page.</p>
		...
		<h2>Cookies</h2>
		<p>We employ the use of cookies. By using The Social Shopping's website you consent to the use of cookies in accordance with The Social Shopping&rsquo;s privacy policy.</p>
		...
		<h2>License</h2>
		<p>Unless otherwise stated, The Social Shopping and/or it&rsquo;s licensors own the intellectual property rights for all material on The Social Shopping. All intellectual property rights are reserved. You may view and/or print pages from https://www.the-social-shopping.com for your own personal use subject to restrictions set in these terms and conditions.</p>
		<p>You must not:</p>
		<ol>
		<li>Republish material from https://www.the-social-shopping.com</li>
		<li>Sell, rent or sub-license material from https://www.the-social-shopping.com</li>
		<li>Reproduce, duplicate or copy material from https://www.the-social-shopping.com</li>
		</ol>
		<p>Redistribute content from The Social Shopping (unless content is specifically made for redistribution).</p>
		<h2>User Comments</h2>
		<ol>
		<li>This Agreement shall begin on the date hereof.</li>
		<li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. The Social Shopping does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions ofThe Social Shopping, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws The Social Shoppingshall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</li>
		<li>The Social Shoppingreserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</li>
		...
		<li>You hereby grant to <strong>The Social Shopping</strong> a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
		</ol>
		...
		<p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect unfavorably on us or our accredited businesses (for example, trade associations or other organizations representing inherently suspect types of business, such as work-at-home opportunities, shall not be allowed to link); (b)the organization does not have an unsatisfactory record with us; (c) the benefit to us from the visibility associated with the hyperlink outweighs the absence of The Social Shopping; and (d) where the link is in the context of general resource information or is otherwise consistent with editorial content in a newsletter or similar product furthering the mission of the organization.</p>
		...
		<p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to <a title='send an email to cdebattista@devsapps.com' href='mailto:cdebattista@devsapps.com'>cdebattista@devsapps.com</a>. Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
		...
		<p>No use of The Social Shopping&rsquo;s logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
		<h2>Iframes</h2>
